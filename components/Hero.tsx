  ...
  return (
    <section className="relative min-h-[100dvh] overflow-hidden bg-bravino-black text-bravino-cream">
      ...
      <div className="grid min-h-[100dvh] grid-cols-1 lg:grid-cols-2">
        <div className="flex bg-bravino-black px-4 pb-12 pt-24 md:px-6 md:pb-14 md:pt-28 lg:px-16 lg:pb-20 lg:pt-32 xl:px-24">
          <div className="my-auto max-w-2xl">
            <h1 className="font-serif text-5xl leading-none tracking-tight text-bravino-cream md:text-6xl lg:text-[4.5rem]">
              ...
              <span className="block mt-2">Onde cada taça</span>
            ...
            <button
              type="button"
              className="mt-10 inline-flex bg-bravino-red px-8 py-4 font-sans text-sm font-medium uppercase tracking-[0.08em] text-bravino-cream transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] hover:shadow-[0_0_20px_rgba(114,47,55,0.4)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-bravino-peach focus-visible:ring-offset-2 focus-visible:ring-offset-bravino-black"
            >
        ...
        <div className="relative min-h-[46dvh] lg:min-h-[100dvh]">
          <video
            autoPlay
            muted
            loop
