...
export default function FooterSection() {
  ...
  return (
    <footer ref={containerRef} className="bg-bravino-black text-bravino-cream relative z-20">
      <div className="relative z-10 mx-auto w-full max-w-[1400px] px-4 py-12 md:px-6 md:py-20 lg:px-12 lg:py-24">
        <div className="grid grid-cols-1 gap-14 sm:grid-cols-2 xl:grid-cols-4">
          <section className="footer-col space-y-6">
            <h3 className="font-sans text-xs md:text-sm font-semibold uppercase tracking-[0.2em] text-bravino-peach">Brand</h3>
            <div className="inline-flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-sans text-[0.65rem] md:text-xs font-semibold uppercase tracking-[0.2em] text-bravino-peach">Wine Concept</p>
              </div>
            </div>
            <p className="max-w-xs font-sans text-sm md:text-base leading-relaxed text-bravino-cream/80 pt-2">
          ...
          <section className="footer-col flex flex-col gap-5">
            <h3 className="font-sans text-xs md:text-sm font-semibold uppercase tracking-[0.2em] text-bravino-peach">Unidade Ayrton Senna</h3>
          ...
          <section className="footer-col flex flex-col gap-5">
            <h3 className="font-sans text-xs md:text-sm font-semibold uppercase tracking-[0.2em] text-bravino-peach">Unidade Santana</h3>
            <div className="inline-flex items-center gap-3 text-bravino-cream/90 pt-1">
              <Clock3 className="h-4 w-4 text-bravino-peach" strokeWidth={1.8} />
              <p className="font-sans text-sm md:text-base leading-relaxed">Seg a Sáb: 11h às 23h</p>
            </div>
             <Link
          ...
          <section className="footer-col space-y-6">
            <h3 className="font-sans text-xs md:text-sm font-semibold uppercase tracking-[0.2em] text-bravino-peach">Socials & Links</h3>
