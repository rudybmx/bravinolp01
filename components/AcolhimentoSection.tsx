    ...
    <section ref={containerRef} className="bg-bravino-cream text-bravino-black relative overflow-hidden">
      <div className="relative z-10 mx-auto w-full max-w-[1400px] px-4 py-20 md:px-6 md:py-24 lg:px-12 lg:py-32">
        <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-16">
          <article className="acolhimento-article">
          <div className="acolhimento-text">
            <span className="mb-8 block h-[2px] w-28 bg-bravino-peach/80" aria-hidden="true" />
            
            <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold leading-none tracking-tight text-bravino-red">A BRAVINO</h2>
            
            <p className="mt-8 max-w-xl font-sans text-base md:text-lg leading-relaxed text-bravino-black/90 md:max-w-lg">
          ...
          <div className="feature-container mt-16 flex flex-wrap items-center gap-8">
            {features.map(({ icon: Icon, label }) => (
              <div key={label} className="feature-item inline-flex items-center gap-4">
                ...
                <span className="font-sans text-xs md:text-sm font-semibold uppercase tracking-[0.2em] text-bravino-black/80">{label}</span>
              </div>
            ))}
          </div>
        </article>

        <aside className="acolhimento-aside relative h-full pt-16 lg:pt-0 lg:border-l lg:border-bravino-peach/20 lg:pl-16">
          ...
          <div className="relative mx-auto flex h-full w-full max-w-2xl flex-col pt-[5rem] lg:pt-[7.6rem]">
            <p className="acolhimento-aside-item font-serif text-3xl md:text-4xl italic leading-tight text-bravino-red drop-shadow-sm">
            ...
            <div className="space-y-8">
              <p className="acolhimento-aside-item border-t border-bravino-peach/40 pt-6 font-serif text-xl md:text-2xl leading-relaxed text-bravino-black/90">
